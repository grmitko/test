...
Breakout.Levels = [
  ...
  { colors: Breakout.Colors.pastel,
    bricks: [
      ...
      "  ooggGGggGG     GGggGGggoo  ",
      "  ooppPPppPP      pPPppPPppoo  ",
      "  ooppPPppPP      pPPppPPppoo  ",
      "  ooppPPppPP     PppPPppoo  ",
      "  ooppPPppBB     bBBppPPppoo  ",
      "  ooppPPbbBB      oBBbbPPppoo  ",
      "  ooppBBbbOOo      oOObbBBppoo  ",
  ...
  { colors: {
    ...
    bricks: [
      ...
      "          BbBsSsBbBbdddd       bBb       ",
      "          BbcCcbdddddddd   ",
      "     zaaaaaaaa      bcwcCsbcwcCsb  ",
      "     zaaaaaaaa      bcCcCsbcCcCsb  ",
      "     zaaaaaaaa      bcCcsSbcCcsSb  ",
      "     zzzzzzzaa      bsSsbabsSsbaa   ",
      "     aaaaaaaaa      bBbaaaaaaaaaa   ",
      "                              ",
      "                              ",
      "                              ",
      "                              ",
